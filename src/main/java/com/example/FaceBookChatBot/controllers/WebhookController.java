...
// logger.debug("Received Webhook verification request - mode: {} | verifyToken:
// {} | challenge: {}", mode,
...
// @RequestHeader(SIGNATURE_HEADER_NAME) final String signature) throws
...
// sendTextMessageUser(senderId, "Tôi là bot chỉ có thể xử lý tin nhắn văn
// bản.");
// }
// });
...
// private void handleTextMessageEvent(TextMessageEvent event) throws
// MessengerApiException, MessengerIOException {
// final String senderId = event.senderId();
// sendTextMessageUser(senderId, "Tú Khuyên gà vãi luôn cậu có biết không ?");
